...
void Lexer::make_tokens(std::string line_to_lex)
{
    ...
    for (int i = 0; i < line_to_lex.length(); i++)
    {
        ...
        if (std::isdigit(line_to_lex[i]))
        {
            ...
            tokenVector->push_back(Token(INT, str_formed));
        }
        ...
        else if (line_to_lex[i] == '\"')
        {
            ...
            tokenVector->push_back(Token(STRING, str_formed));
        }
        ...
        else if (std::isalpha(line_to_lex[i]))
        {
            ...
            {
                tokenVector->push_back(Token(T_KEYWORD_LAMBDA, str_formed));
            }*/
            if (str_formed == T_KEYWORD_IF)
            {
                tokenVector->push_back(Token(T_KEYWORD_IF, str_formed));
            }
            else if (str_formed == T_KEYWORD_ELIF)
            {
                tokenVector->push_back(Token(T_KEYWORD_ELIF, str_formed));
            }
            else if (str_formed == T_KEYWORD_ELSE)
            {
                tokenVector->push_back(Token(T_KEYWORD_ELSE, str_formed));
            }
            else if (str_formed == T_KEYWORD_PRINT)
            {
                tokenVector->push_back(Token(T_KEYWORD_PRINT, str_formed));
            }
            else if (str_formed == T_KEYWORD_AND)
            {
                tokenVector->push_back(Token(T_KEYWORD_AND, str_formed));
            }
            else if (str_formed == T_KEYWORD_OR)
            {
                tokenVector->push_back(Token(T_KEYWORD_OR, str_formed));
            }
            else if (str_formed == T_KEYWORD_NOT)
            {
                tokenVector->push_back(Token(T_KEYWORD_NOT, str_formed));
            }
            else
            {
                tokenVector->push_back(Token(T_IDENTIFIER, str_formed));
            }
        }
        ...
        else if (line_to_lex[i] == '=')
        {
            if (line_to_lex[i + 1] == '=')
            {
                /* == */
                i++;
                tokenVector->push_back(Token(T_EQUAL_EQUAL,
                                             "=="));
            }
            else
            {
                /* = */
                tokenVector->push_back(Token(ASSIGNMENT,
                                             std::string(1, '=')));
            }
        }
        ...
        else if (line_to_lex[i] == '!')
        {
            ...
            if (line_to_lex[i + 1] == '=')
            {
                ...
                tokenVector->push_back(Token(T_NOT_EQUAL,
                                             "!="));
            }
            else
            {
        ...
        else if (line_to_lex[i] == '<')
        {
            ...
            if (line_to_lex[i + 1] == '=')
            {
                /* <= */
                i++; //advance token an extra time
                tokenVector->push_back(Token(T_LESS_THAN_EQUAL,
                                             "<="));
            }
            else
            {
                /* < */
                tokenVector->push_back(Token(T_LESS_THAN,
                                             std::string(1, '<')));
            }
        }
        ...
        else if (line_to_lex[i] == '>')
        {
            if (line_to_lex[i + 1] == '=')
            {
                /* >= */
                i++; //advance token an extra time
                tokenVector->push_back(Token(T_GREATER_THAN_EQUALS,
                                             ">="));
            }
            else
            {
                /* > */
                tokenVector->push_back(Token(T_GREATER_THAN,
                                             std::string(1, '>')));
            }
        }
        ...
        {
            tokenVector->push_back(Token(ADD,
        ...
        {
            tokenVector->push_back(Token(MINUS,
                                         std::string(1, line_to_lex[i])));
        }
        ...
        {
            tokenVector->push_back(Token(T_DIVIDE,
                                         std::string(1, line_to_lex[i])));
        }
        ...
        {
            tokenVector->push_back(Token(MULTIPLY,
                                         std::string(1, line_to_lex[i])));
        }
        else if (line_to_lex[i] == '[')
        {
            tokenVector->push_back(Token(T_LEFT_BRACKET,
                                         std::string(1, line_to_lex[i])));
        }
        else if (line_to_lex[i] == ']')
        {
            tokenVector->push_back(Token(T_RIGHT_BRACKET,
                                         std::string(1, line_to_lex[i])));
        }
        else if (line_to_lex[i] == '(')
        {
            tokenVector->push_back(Token(T_LEFT_PAREN,
                                         std::string(1, line_to_lex[i])));
        }
        else if (line_to_lex[i] == ')')
        {
            tokenVector->push_back(Token(T_RIGHT_PAREN,
                                         std::string(1, line_to_lex[i])));
        }
        else if (line_to_lex[i] == ':')
        {
            tokenVector->push_back(Token(T_COLON,
                                         std::string(1, line_to_lex[i])));
        }
        
        else if (line_to_lex[i] == ',')
        {
            tokenVector->push_back(Token(T_COMMA,
                                         std::string(1, line_to_lex[i])));
        }
 ...
 */
    ...
    else if (current_token.get_token_type() == T_IDENTIFIER)
    {
        ...
        if (current_token.get_token_type() ==
                     T_IDENTIFIER &&
                 (*tokenVector)[current_token_index + 1].get_token_type() == T_LEFT_PAREN)
        {
